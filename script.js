document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        tr: {
            ...
            'hero-title': 'Yapay Zeka Tasarımları / Sosyal Medya & Meta Reklam Yönetimi',
            'hero-desc': 'AI destekli yaratıcı tasarımlar, sosyal medya yönetimi ve Meta reklam kampanyalarıyla markanızı bir adım öne taşıyoruz.',
            'hero-btn': 'Teklif Al',
            ...
            'detail-meta-title': 'Meta Reklam Yönetimi',
            'detail-meta-desc': 'Facebook ve Instagram reklam kampanyalarınızı optimize ediyor, hedef kitle analizi ile ROAS\'ınızı artırıyoruz.',
            ...
            'about-p2': 'AI görsel tasarımından sosyal medya yönetimine, Meta (Facebook & Instagram) reklam kampanyalarından marka kimliği oluşturmaya kadar geniş bir yelpazede çözümler üretiyoruz.',
            'label-location': 'Konum',
            'value-location': 'Türkiye',
            'label-expertise': 'Uzmanlık',
            'value-expertise': 'AI Tasarım, Sosyal Medya, Meta Ads',
            ...
            'service-meta-title': 'Meta Reklam Yönetimi',
            ...
            'contact-desc': 'Markanız için AI tasarım, sosyal medya veya Meta reklam desteği mi istiyorsunuz? Hemen ulaşın.',
            ...
            'page-title': 'distylta | Yapay Zeka Tasarımları / Sosyal Medya & Meta Reklam Yönetimi'
        },
        en: {
            'nav-about': 'About Us',
            ...
            'nav-process': 'Process',
            'nav-contact': 'Contact',
            'hero-title': 'AI Designs / Social Media & Meta Ad Management',
            'hero-desc': 'We take your brand one step ahead with AI-powered creative designs, social media management and Meta ad campaigns.',
            'hero-btn': 'Get Quote',
            ...
            'detail-meta-title': 'Meta Ad Management',
            'detail-meta-desc': 'We optimize your Facebook and Instagram ad campaigns and increase your ROAS with target audience analysis.',
            ...
            'about-p2': 'We provide solutions across a wide range from AI visual design to social media management, from Meta (Facebook & Instagram) ad campaigns to brand identity creation.',
            'label-location': 'Location',
            'value-location': 'Turkey',
            'label-expertise': 'Expertise',
            'value-expertise': 'AI Design, Social Media, Meta Ads',
            ...
            'contact-desc': 'Looking for AI design, social media or Meta ad support for your brand? Get in touch now.',
            ...
            'page-title': 'distylta | AI Designs / Social Media & Meta Ad Management'
        }
    };
