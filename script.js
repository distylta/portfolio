document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        tr: {
            ...
            'hero-title': 'Sosyal Medya ve Meta Reklam Yönetimi',
            ...
            'page-title': 'distylta | Sosyal Medya ve Meta Reklam Yönetimi'
        },
        en: {
            'nav-about': 'About Us',
            ...
            'nav-process': 'Process',
            'nav-contact': 'Contact',
            'hero-title': 'Social Media & Meta Ads Management',
            ...
            'page-title': 'distylta | Social Media & Meta Ads Management'
        },
        ar: {
            'nav-about': 'نبذة عنا',
            ...
            'hero-title': 'إدارة السوشيال ميديا وإعلانات ميتا',
            ...
            'ph-message': 'رسالتك',
            'page-title': 'distylta | إدارة السوشيال ميديا وإعلانات ميتا'
        }
    };
