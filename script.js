document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        tr: {
            ...
            'hero-title': 'Sosyal Medya / Meta Reklam / Google Reklam Yönetimi / AI Tasarımlar',
            ...
            'detail-google-title': 'Google Reklam Yönetimi',
            'detail-google-desc': 'Google Arama, Display ve Alışveriş kampanyalarıyla doğru kitleye ulaşıyor, reklam bütçenizi maksimum verimle yönetiyoruz.',
            ...
            'service-google-title': 'Google Reklam Yönetimi',
            ...
            'contact-desc': 'Markanız için AI tasarım, sosyal medya, Meta veya Google reklam desteği mi istiyorsunuz? Hemen ulaşın.',
        ...
        en: {
            ...
            'nav-process': 'Process',
            'nav-contact': 'Contact',
            'hero-title': 'Social Media / Meta Ads / Google Ad Management / AI Designs',
            ...
            'detail-google-title': 'Google Ad Management',
            'detail-google-desc': 'We reach the right audience with Google Search, Display and Shopping campaigns, managing your ad budget for maximum efficiency.',
