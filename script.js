document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        tr: {
            ...
            'sphere-invoice': 'Yapay Zeka Destekli<br>Fatura & Ürün Girişi Hizmeti',
            ...
            'step-4-title': 'Fatura Yükleme & Ürün Girişi Hizmeti',
            'step-4-desc': 'Faturalarınızı bize iletirsiniz, yapay zekamız fatura bilgilerini okur ve ürün/stok kayıtlarını otomatik olarak sisteminize girer.',
        ...
        en: {
            ...
            'sphere-invoice': 'AI-Powered<br>Invoice & Product Entry Service',
            ...
            'step-4-title': 'Invoice Upload & Product Entry Service',
            'step-4-desc': 'You send us your invoices, and our AI reads the invoice details and automatically enters the product/stock records into your system.',
        ...
        ar: {
            ...
            'sphere-invoice': 'خدمة إدخال الفواتير والمنتجات<br>بالذكاء الاصطناعي',
            ...
            'step-4-title': 'خدمة رفع الفواتير وإدخال المنتجات',
            'step-4-desc': 'ترسلون لنا فواتيركم، ويقوم الذكاء الاصطناعي بقراءة بيانات الفاتورة وإدخال سجلات المنتجات والمخزون في نظامكم تلقائياً.',
