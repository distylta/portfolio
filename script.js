document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        tr: {
            ...
            'hero-title': 'Yapay Zeka Destekli Fotoğraf/Video Tasarımları / Web Sitesi / Otomasyon/Dijital Ürünler',
        ...
        en: {
            ...
            'nav-process': 'Process',
            'nav-contact': 'Contact',
            'hero-title': 'AI-Powered Photo/Video Designs / Website / Automation/Digital Products',
