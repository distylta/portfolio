document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        tr: {
            ...
            'about-p1': '<strong>7K Dijital Pazarlama</strong>, Hatice Urgaç tarafından yürütülen freelance bir dijital pazarlama hizmetidir; markaların sosyal medyada etkili bir varlık göstermesini ve Meta & Google reklam kampanyalarıyla büyümesini sağlar.',
        ...
        en: {
            ...
            'about-p1': '<strong>7K Dijital Pazarlama</strong> is a freelance digital marketing service led by Hatice Urgaç, helping brands build an effective social media presence and grow through Meta & Google ad campaigns.',
        ...
        ar: {
            ...
            'about-p1': '<strong>7K Dijital Pazarlama</strong> خدمة تسويق رقمي فريلانس بقيادة Hatice Urgaç، تساعد العلامات التجارية على بناء حضور فعّال في وسائل التواصل الاجتماعي والنمو من خلال حملات إعلانات ميتا وجوجل.',
