document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        tr: {
            ...
            'hero-title': 'Yapay Zeka Destekli Dijital Pazarlama & Meta Reklam Yönetimi',
        ...
        en: {
            ...
            'nav-process': 'Process',
            'nav-contact': 'Contact',
            'hero-title': 'AI-Powered Digital Marketing & Meta Ads Management',
        ...
        ar: {
            ...
            'hero-title': 'تسويق رقمي وإدارة إعلانات ميتا بالذكاء الاصطناعي',
